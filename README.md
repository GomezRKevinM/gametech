...
- Tenemos que construir un html basico donde el usuario pueda jugar el clasico juego de **Piedra papel o tijera**

- Es necesario crear un evento para dar inicio a la partida.
...
- Jair Andres Hamburguer Estrada.